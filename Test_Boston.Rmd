      ...
      sidebarLayout(
          ...
          sidebarPanel(
            ...
            sliderInput(inputId = "animation", 
                        ...
                        sep = ""),
          tags$h5("Press play to begin!"), tags$a(href="http://www.baa.org/races/boston-marathon/boston-marathon-history/participation.aspx", "Participation Data from 1972-2017")),
...
<<<<<<< HEAD
      ...
      tabPanel(title = "More Information",
               fluidPage(
                 br(),
                 p("The following are links to the data we used for this app:",
                   br(),
                   tags$a(href="https://github.com/llimllib/bostonmarathon", "Data from 2001-2014"),
                   br(),
                  tags$a(href="https://www.kaggle.com/rojour/boston-results/data", "Data from 2015-2017"),
...
>>>>>>> db8206a6cb6d8211e8ae722de1dab34d84e5037d
  ))
)
